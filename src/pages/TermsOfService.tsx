      ...
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="bg-black/40 backdrop-blur-sm border border-dark-border rounded-xl p-8 md:p-12 space-y-8 text-gray-300 leading-relaxed">
          ...
          <section>
            ...
            <p>
              By accessing or using Zoo.Computer (the "Service"), operated by Zoo Labs Foundation ("Zoo Labs", "we", "us", or "our"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use the Service.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-white mb-4">2. Services Provided</h2>
            <p className="mb-4">Zoo.Computer provides:</p>
            <ul className="list-disc list-inside space-y-2 pl-4">
              ...
              <li><strong>Cloud Services:</strong> Access to GPU compute resources via Zoo Cloud</li>
          ...
          <section>
            ...
            <p>
              We offer a 7-day money-back guarantee for DGX Spark purchases. Refunds are prorated based on compute hours used. To request a refund, contact support@zoo.ngo.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 pl-4 mb-4">
              ...
              <li>All payments processed via Zoo Billing</li>
          ...
          <section>
            ...
            <p className="mb-4">
              All content, trademarks, and intellectual property on Zoo.Computer are owned by Zoo Labs Foundation or its licensors. You retain all rights to data and models you create using our services.
            </p>
            <p>
          ...
          <section>
            ...
            <p>
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, ZOO LABS SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS OR REVENUES, WHETHER INCURRED DIRECTLY OR INDIRECTLY, OR ANY LOSS OF DATA, USE, GOODWILL, OR OTHER INTANGIBLE LOSSES.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              You agree to indemnify and hold harmless Zoo Labs, its officers, directors, employees, and agents from any claims, damages, losses, liabilities, and expenses arising from your use of the Service or violation of these Terms.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="mt-4 p-4 bg-black/40 rounded-lg border border-dark-border">
              <p><strong>Zoo Labs Foundation</strong></p>
              <p>Email: <a href="mailto:legal@zoo.ngo" className="text-primary hover:underline">legal@zoo.ngo</a></p>
              <p>Support: <a href="mailto:support@zoo.ngo" className="text-primary hover:underline">support@zoo.ngo</a></p>
              <p>Website: <a href="https://zoo.ngo" className="text-primary hover:underline">zoo.ngo</a></p>
            </div>
          </section>
        ...
        <div className="mt-8 text-center text-gray-500 text-sm">
          <p>By using Zoo.Computer, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.</p>
        </div>
      </div>
    </div>
  );
