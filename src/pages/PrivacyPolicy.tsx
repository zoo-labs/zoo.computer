      ...
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="bg-black/40 backdrop-blur-sm border border-dark-border rounded-xl p-8 md:p-12 space-y-8 text-gray-300 leading-relaxed">
          ...
          <section>
            ...
            <p>
              Zoo Labs Foundation ("Zoo Labs", "we", "us", or "our") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use Zoo.Computer (the "Service").
            </p>
            <p className="mt-4">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 pl-4 mb-4">
              <li><strong>Payment Processing:</strong> Zoo Commerce (for secure payment handling)</li>
          ...
          <section>
            ...
            <p className="mt-4">
              You may request deletion of your data at any time by contacting us at privacy@zoo.ngo. We will comply with deletion requests within 30 days, subject to legal retention requirements.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-4">
              To exercise any of these rights, please contact us at privacy@zoo.ngo. We will respond to your request within 30 days.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-4">
              If you believe we have collected information from a child, please contact us at privacy@zoo.ngo.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              The Service may contain links to third-party websites (such as zoo.ngo, NVIDIA, and partner sites). We are not responsible for the privacy practices of these external sites. We encourage you to review the privacy policies of any third-party sites you visit.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="mt-4 p-4 bg-black/40 rounded-lg border border-dark-border">
              ...
              <p>Email: <a href="mailto:privacy@zoo.ngo" className="text-primary hover:underline">privacy@zoo.ngo</a></p>
          ...
          <section>
            ...
            <div className="mt-4 p-4 bg-black/40 rounded-lg border border-dark-border">
              ...
              <p>Email: <a href="mailto:dpo@zoo.ngo" className="text-primary hover:underline">dpo@zoo.ngo</a></p>
            </div>
          </section>
        ...
        <div className="mt-8 text-center text-gray-500 text-sm">
          <p>By using Zoo.Computer, you acknowledge that you have read and understood this Privacy Policy.</p>
        </div>
      </div>
    </div>
  );
