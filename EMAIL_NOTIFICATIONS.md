...
Comprehensive email notification system for Zoo Computer platform, providing automated email communications for quotes, orders, subscriptions, and RFQs.
...
VITE_EMAIL_FROM=noreply@zoo.computer
VITE_ADMIN_EMAIL=admin@zoo.computer
...
3. Verify your sender domain (zoo.computer)
...
### Header
- Zoo Computer logo and branding
...
- Email: support@zoo.computer
- Documentation: https://zoo.computer/docs
- GitHub Issues: https://github.com/zaboratory/computer
