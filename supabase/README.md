# Supabase Setup for Zoo.Computer

This directory contains the database schema and setup instructions for the Zoo.Computer leasing platform.
...
5. ⏳ Integrate Zoo Commerce for payments
