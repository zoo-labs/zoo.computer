...
const FAQ: React.FC = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Absolutely. Start with DGX Spark and seamlessly scale to Zoo Cloud for on-demand H100/H200 access, or upgrade to dedicated SuperPODs for enterprise workloads. Your data and configurations can migrate easily across our infrastructure."
    },
    {
    ...
    },
    {
      ...
      answer: "After your included 100 hours, you can top up compute time at competitive rates, upgrade to Zoo Cloud for flexible pay-as-you-go access, or maintain your instance for data storage at a low monthly rate while you plan your next project."
    },
    {
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Everything you need to know about Zoo.Computer and our AI infrastructure
          </p>
        </div>
