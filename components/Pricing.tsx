      ...
      {plan.purchaseMethod === 'sales' && (
        <div className="mb-4 p-3 bg-secondary/10 border border-secondary/30 rounded-lg">
          <p className="text-sm text-secondary font-semibold flex items-center gap-2">
            ...
            {plan.id === 'cloud-compute' ? 'Visit Zoo Cloud' : 'Contact Sales Required'}
          </p>
        </div>
      )}
...
const gpuPlans = [
    ...
    },
    {
        ...
        priceValue: 50000,
        period: 'per GPU',
        description: 'Blackwell Ultra B300 GPU with 288GB HBM3e memory. The most powerful single GPU for frontier AI training and inference.',
        features: [
            'Single NVIDIA B300 GPU',
            '288 GB HBM3e Memory',
            '12 TB/s Memory Bandwidth',
            'Blackwell Ultra Architecture',
            'NVLink 5.0 Interconnect',
            '2nd Gen Transformer Engine',
            'FP4 / FP8 / FP16 Support',
            'Enterprise Support',
        ],
        cta: 'Contact Sales',
        purchaseMethod: 'sales' as const,
    ...
    },
    {
        ...
        priceValue: 399000,
        leasePrice: '$29,999',
        leasePriceValue: 29999,
        period: '',
        description: '8x B200 GPUs + 2x Grace CPUs in a single rack-scale system. 1.4 EXAFLOPS FP4 performance with 1,536GB total HBM3e memory.',
        features: [
            '8x NVIDIA B200 GPUs',
            '2x NVIDIA Grace CPUs',
            '1.4 EXAFLOPS FP4 Performance',
            '1,536 GB Total HBM3e Memory',
            'NVLink 5.0 Interconnect',
        ...
        leaseFeatures: [
            '8x NVIDIA B200 GPUs + 2x Grace CPUs',
            '1.4 EXAFLOPS FP4 Performance',
            '1,536 GB Total HBM3e Memory',
            'NVLink 5.0 Interconnect',
            'Direct Liquid Cooling',
    ...
    {
        id: 'h200-8x-standalone',
        name: '8X NVIDIA H200 (Standalone)',
        price: 'Contact Sales',
        priceValue: 0,
        period: 'Lease Starting at $21,199/mo',
        description: '8X NVIDIA H200 GPUs with 141GB HBM3e per GPU. Lease terms: Annual ($21,199/mo), 6-Month ($23,849/mo), 3-Month ($25,174/mo), Monthly ($26,499/mo).',
        features: [
            '8X NVIDIA H200 GPUs',
            ...
            '960GB NVMe + (4) 3.84TB NVMe',
            '25Gb Bonded Network (3200Gb Available)',
            'Annual: $21,199/mo ($3.63/GPU-hr)',
            '6-Month: $23,849/mo ($4.08/GPU-hr)',
            '3-Month: $25,174/mo ($4.31/GPU-hr)',
            'Monthly: $26,499/mo ($4.54/GPU-hr)',
        ],
        cta: 'Contact Sales',
        purchaseMethod: 'sales' as const,
        salesLink: 'https://zoo.ngo/contact',
    ...
    },
    {
        ...
        priceValue: 0,
        period: '',
        description: 'Need on-demand GPU access? Check out Zoo Cloud for flexible, pay-as-you-go Blackwell and Hopper GPU compute.',
        features: [
            'Access to B300, B200, H200 & H100 GPUs',
            'Scale from 1 to 100s of GPUs',
            'Pay only for what you use',
            'Ideal for Inference & Fine-tuning',
            'Full Zoo Labs Cloud Platform',
        ],
        cta: 'Visit Zoo Cloud',
        purchaseMethod: 'sales' as const,
        salesLink: 'https://zoo.ngo',
    },
    {
        id: 'dgx-b200',
