      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
            Explore Zoo Cloud for On-Demand GPU Access
          </h2>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto mb-4">
            While we recommend <strong className="text-white">buying your own hardware</strong> for the best value and control, Zoo Cloud offers flexible, pay-as-you-go GPU instances when you need them.
          </p>
          <a
            href="https://zoo.ngo"
            target="_blank"
          ...
          <p className="text-sm text-gray-500 max-w-2xl mx-auto mb-8">
            Reference pricing shown below for cloud instances. For detailed cloud pricing and instant deployment, visit Zoo Labs.
          </p>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-400 text-sm">Optional full infrastructure management by Zoo Labs</p>
          </div>
        </div>
      </div>
    </section>
