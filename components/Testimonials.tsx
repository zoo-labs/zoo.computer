...
const Testimonials: React.FC = () => {
  const testimonials = [
    ...
    {
      quote: "Moving to Zoo.Computer's infrastructure cut our training time by 60%. The H200 GPUs are game-changing for our generative AI workloads.",
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Join leading researchers and companies accelerating their AI development with Zoo.Computer
          </p>
        </div>
